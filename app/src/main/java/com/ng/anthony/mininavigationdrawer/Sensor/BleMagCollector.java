...
//        Log.d("BleMagCollector","accdata "+ acctemp);
//        Log.d("BleMagCollector","grivaty "+ grivaty);
        if("".equals(bledata)) return;

        try {
            count++;
            String result =  HttpHelper.sendJsonPost(magdata,bledata,accdata,orientdata,acctemp,grivaty,"BleMag",0,count,mapIndex,deviceId);
